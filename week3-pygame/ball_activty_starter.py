...
# Ball 2
possible_ball2_colors = [BLACK, WHITE, GREEN, RED, BLUE, GREY]
...
while not done:
    ...
    ball2_color = random.choice(possible_ball2_colors) # This is outside because of variable scoping.



    pygame.draw.circle(screen, ball2_color, [x_loc, y_loc], ball2_size)



    if x_loc >= SCREEN_WIDTH - ball2_size or x_loc < ball2_size:
        x_s = x_s * -1

    if y_loc >= SCREEN_HEIGHT - ball2_size or y_loc < ball2_size:
        y_s = y_s * -1
