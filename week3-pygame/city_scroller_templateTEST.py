...
class Building():
    ...
    def draw(self):
        pygame.draw.rect (screen, random_index, (self.x_point, self.y_point, self.width, self.height))
        """
...
build = Building (700, 250, 100, 350, random_index)
build1 = Building (700, 250, 150, 350, BLUE)
# -------- Main Program Loop -----------
while not done:
    # --- Main event loop
